...
- .mono[R] has a vibrant, thriving online community. ([stack overflow](https://stackoverflow.com/questions/tagged/r))
...
3\. .mono[R] is very __flexible and powerful__—adaptable to nearly any task, _e.g._, 'metrics, spatial data analysis, machine learning, web scraping, data cleaning, website building, teaching. My website, the TWEEDS website, and these notes all came out of .mono[R].
...
- Your GEs
- Me
- .mono[R] resources [here](http://edrub.in/ARE212/resources.html) and [here](https://www.rstudio.com/online-learning/)
...
# PDF with pauses
xaringan::decktape("01-intro.html", "01-intro.pdf")
# PDF without pauses
pagedown::chrome_print("01-intro.html", "01-intro-no-pause.pdf")
```
